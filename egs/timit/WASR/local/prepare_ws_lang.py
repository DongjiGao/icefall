...
def main():
    ...
    ws_lexicon_filename = lang_dir / "ws_lexicon.txt"

    lexicon = read_lexicon(lexicon_filename)
    ws_lexicon = read_lexicon(ws_lexicon_filename)

    # If lexicon has N tokens and N words (identical), 
    # we_lexicon would have N+1 tokens (<star>) and 2N words:
    # Each word has a fake version (e.g., ae and ~ae)
    tokens = get_tokens(ws_lexicon)
    words = get_words(ws_lexicon)
